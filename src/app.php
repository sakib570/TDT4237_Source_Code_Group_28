...
$app = new Slim([
    ...
    'debug' => false, // Donot display debugging output
    'view' => new Twig()
...
$app->get('/patents/search', $ns . 'PatentsController:search')->name('searchpatent');//sri krishna
$app->get('/patents/name', $ns . 'PatentsController:searchResults');//sri krishna
